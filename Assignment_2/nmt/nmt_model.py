...
class NMT(nn.Module):
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        dec_hidden_us = torch.unsqueeze(dec_hidden, dim=1) # (b, 1, h)
        e_t = dec_hidden_us.matmul(enc_hiddens_proj.permute(0,2,1)) # (b, src_len)
        ...
        a_t = alpha_t.matmul(enc_hiddens).squeeze(dim = 1) # (b, 2h)
